...
def main():
    print("=" * 70)
    print("  Combined DBGSOM Demo: Ecoli Dataset")
    print("=" * 70)

    # 1. Load Data
    print("\n1. Loading Ecoli dataset...")
    data_path = Path(__file__).parent.parent / "data" / "ecoli.csv"
    df_raw = pd.read_csv(data_path)
    
    # Drop irrelevant column
    if 'Sequence_Name' in df_raw.columns:
    ...
    # 4. Visualizations
    print("\n4. Visualizations...")
    viz = DBGSOMVisualizer(Path(__file__).parent.parent / "output", "ecoli_combined")
