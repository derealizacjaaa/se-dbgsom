...
def main():
    print("=" * 70)
    print("  Combined DBGSOM Demo: Two Moons Dataset")
    print("=" * 70)

    # 1. Load Data
    print("\n1. Loading Two Moons dataset...")
    data_path = Path(__file__).parent.parent / "data" / "two_moons.csv"
    ...
    # 4. Visualizations
    print("\n4. Visualizations...")
    viz = DBGSOMVisualizer(Path(__file__).parent.parent / "output", "two_moons_combined")
